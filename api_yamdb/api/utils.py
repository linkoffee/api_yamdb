...
# Как достать правильно файл настроек: https://docs.djangoproject.com/en/4.0/topics/settings/#using-settings-in-python-code
...
def generate_and_send_confirmation_code_to_email(username):
    # Пользователя нужно передавать в эту функцию, а не получать его.
