# Generated by Django 3.2.16 on 2024-07-15 10:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'user'), ('admin', 'admin'), (
                    'moderator', 'moderator')], default='user', max_length=9, verbose_name='Роль')),
                ('bio', models.TextField(blank=True, verbose_name='Описание')),
                ('email', models.EmailField(max_length=254,
                 unique=True, verbose_name='Электронная почта')),
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(
                    message='Недопустимые символы в username', regex='^[\\w.@+-]+\\Z'), reviews.validators.username_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(db_index=True, validators=[django.core.validators.MinValueValidator(
                    0), django.core.validators.MaxValueValidator(2024)], verbose_name='Год создания произведения')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='titles', to='reviews.category', verbose_name='Категория произведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='reviews', to='reviews.title', verbose_name='Наименование произведения')),
            ],
            options={
                'verbose_name': 'Отзыв',
